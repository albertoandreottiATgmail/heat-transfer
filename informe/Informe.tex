...
\author{Ing. Jos\'e Pablo Alberto Andreotti, Lic. Nicol\'as Wolovick, Dr. Javier Blanco.\\
	\texttt{beto@com}, \texttt{\{nicolasw,blanco\}@famaf.unc.edu.ar}
}
...
%set label 'n' at 10,10
%set grid 10000, 13000
%show grid
%plot  "perf.dat" using 1:2 title 'Fine' , \
     "perf.dat" using 1:3 title 'Gross' 

%set boxwidth 1 relative
%set style data histograms
%set style fill solid 1.0 border -1
%plot 'perf.dat' using 2:xticlabels(1) title 'Fine', "perf.dat" using 3:xticlabels(1) title 'Gross'

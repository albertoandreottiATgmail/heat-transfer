...
This map function is depicted in Figure \ref{fig:map_gross}. Similarly, the reduce 
...
the computation of a whole output row. This leads to a data replication
that is three times the size of the input data.
...
this run the application in a different number of nodes.
